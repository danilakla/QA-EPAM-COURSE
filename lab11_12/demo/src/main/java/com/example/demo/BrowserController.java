...
public class BrowserController {
    ...
    public String uploadPhoto() {
            Predicate<String> var1=( e)->e.length()>0;

            Stream.of("dsd","ds","32").
                filter(Predicate.not((e)->e.length()>10)).
                collect(ArrayList::new, List::add, (e,z)->e.addAll(z) );
...
//        }
        ...
        emailElem.sendKeys("xxxxxx"); // Replace with your email
